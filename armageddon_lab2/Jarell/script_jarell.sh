...
<head>
    ...
    <title> Jarell Jones | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url('https://images.unsplash.com/photo-1579493933703-70473cdf84f8?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <header>
                <h1>Jarell Jones</h1>
                <p>Cloud Engineer | Outdoorsman | Artist</p>
            </header>

            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>I am an artist with a desire to travel.</p>
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
                <img src="https://images.unsplash.com/photo-1642912276984-d8c4c0ec9bc1?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Photon Particle Physics Concept">
